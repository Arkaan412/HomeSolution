...
public class HomeSolutionTestModif {
	...
	public void setUp() {
		...
		homeSolution.registrarProyecto(titulos, descripciones, duracion, "San Martin 1000", cliente, "2025-12-01",
				"2025-12-05");
		...
		homeSolution.registrarProyecto(titulos, descripciones, duracion, "Libertador 500", cliente, "2025-12-10",
				"2025-12-15");
	}
	...
	public void testFinalizarProyectoConFechaInvalidaLanzaExcepcion() {
		...
		try {
			asignarTareas(numeroProyecto); // No puedo finalizar un proyecto con tareas sin asignar, pues nunca pasó a estar activo. Para demostrar ese comportamiento está el test anterior.
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//		homeSolution.finalizarProyecto(numeroProyecto, "2025-12-04");
		...
		homeSolution.finalizarProyecto(numeroProyecto, "2025-11-04");
	}
	...
	public void testCalculaCostoSinRetrasosYReasignacion() throws Exception {
		...
		double costoProyecto = homeSolution.costoProyecto(numeroProyecto);

		assertEquals(costo, costoProyecto, 0.001);
	}
	...
	private double calcularCosto() {
		double costo = 0;
		costo = 15000 * 32; // Juan 480.000
		costo += 80000 * 2 * 1.02; // Luis 160.000 | 163.2000 con bono
		costo += 15000 * 8; // Julieta 120.000
		costo += 50000 * 1 * 1.02; // Carlos 50.000 | 51.000 con bono
		return costo;
	}
	...
	private double calculoCostoConRetraso() {
		return (calcularCosto() - (80000 * 2 * 1.02) + (80000 * 2) - (50000 * 1 * 1.02) + (50000 * 1))  * 1.25;
	}
